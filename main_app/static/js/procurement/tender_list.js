      ...
      {data: "status"},
      {
        ...
        mRender: function (data, type, row) {
          ...
          return "<div class='btn-group'> \
            <a href='/menu/procurement/tenders/offer-price?key="+data.pkey+"' class='btn btn-xs btn-light mg-l-0' id='opl+" + data.pkey + "'><i class='fa fa-pencil' style='width:30px'></i>  </a> \
            </div>";
        },
      }
    ],
