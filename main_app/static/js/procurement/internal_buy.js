...
$(document).ready(function () {
  ...
  var table1 = $('#purchase_order_items_table').DataTable({
    ...
    columns: [  
      ...
      {data: "uom", className:"tt "},
      {
        ...
        mRender: function (data, type, row, meta) {
          ...
          return "<input type='hidden' id='lbl+"+ meta.row +"' value='"+data.quantity+"'><input class='tt text-right float_inp' name='qu+"+ meta.row +"' id='qu+"+ meta.row +"' type='text' value='" + data.quantity + "' " + r + "  /> ";
